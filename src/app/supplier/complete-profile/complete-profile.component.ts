...
export class CompleteProfileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.formThree = this.fb.group({
      businessDescription: [
        // tslint:disable-next-line:max-line-length
        'GoldenLine Technology.,Ltd,since 1996,specializes in researching,Developing,designing,manufacturing and marketing of auodio electronic items,mainly bluetooth headphones,bluetooth speaker,bluetooth sport headset,wired headphone and earphones.iSodo occupies about 3000 sqaure meters, 5 lines for assembling.The output per days is 3600pcs.We have 120 workers ,6 engineers,8QC and there are 8 people in the sales department.After decades of effort,the Brand "GoldenLine" becomes one of the best-known in this industrial.Products and service network cover more than 30 countries and regions.Hereby we sincely invice you to work hand in hand with us to offer your customers perfect items,perfect after-sales services and glorious future.',
        Validators.compose([
      ...
      pftitle: [''],
      mainProducts: [
        'Wired headphone, Bluetooth headset, Bluetooth earphone, Bluetooth speakers, wireless headphone',
        Validators.compose([
    ...
    this.formFive = this.fb.group({
      ...
      nemin: ['201', Validators.compose([Validators.pattern(/^[0-9]*$/)])],
      nemax: ['300', Validators.compose([Validators.pattern(/^[0-9]*$/)])]
    });
  }
